      ...
      <div class="row">
        <div class="col-md-12">
          <div class="row" id='filter'>
              ...
              <div class="col-md-3">
              <label for="">&nbsp;</label> <br> <button type="button" class="btn btn-default btn-block" onclick="clean()"><i class="fas fa-eraser" style="color: red"></i> Limpar</button>
              </div>
          </div>
        </div>
      </div>
...
@section('js')
  ...
  <script>
    ...
    function openModal(solicitacao,index){
      ...
      $.getJSON('/planejamento/get/solicitacao/relacionamento' + '/' + id_relacionamento + '/' + solicitacao.id_solicitacao_troca , function(solicitacao_troca){
    ...
    function acaoSolicitacao(id_solicitacao,tipo){
      ...
      swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url:"/planejamento/acaoSolicitacao",
            method:"POST",
            headers: {
