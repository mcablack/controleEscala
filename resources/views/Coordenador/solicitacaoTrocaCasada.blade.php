      ...
      <table class="table table-striped table-hover table-bordered" id="myTable" width="100%" table-layout:fixed>
        <thead>
          <tr>
            ...
            <th class="tdCenter">Data solicitada</th>
            <th class="tdCenter">Turno solicitado</th>
...
@section('js')
  ...
  <script>
    ...
    function openModal(solicitacao,index){
      ...
      $.getJSON('/coordenador/get/solicitacao/relacionamento' + '/' + id_relacionamento + '/' + solicitacao.id_solicitacao_troca , function(solicitacao_troca){
